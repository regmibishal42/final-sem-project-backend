...
func (r *staffQueryResolver) GetStaffByOrganization(ctx context.Context, obj *model.StaffQuery, input model.FilterStaffInput) (*model.StaffsQueryResponse, error) {
	user := UserForContext(ctx)
	err := CheckLoggedIn(user)
	if err != nil {
